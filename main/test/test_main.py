...
def test_variables_name():
    main_test('echo "$"', '> Variable name can\'t start with quotes\n> ')
    main_test('echo $1', '> Variable name can\'t start with digit\n> ')
    main_test('echo $#', '> Variable name can\'t start with \'#\'\n> ')
...
def test_assignment():
    main_test('x =4', '> [Errno 2] No such file or directory: \'x\'\n> ')
    main_test('x= 4', '> [Errno 2] No such file or directory: \'x=\'\n> ')
    main_test('=4', '> [Errno 2] No such file or directory: \'=4\'\n> ')
    main_test('x=', '> [Errno 2] No such file or directory: \'x=\'\n> ')
    main_test('1=2', '> [Errno 2] No such file or directory: \'1=2\'\n> ')
    main_test('"abc"=2', '> [Errno 2] No such file or directory: \'abc=2\'\n> ')

    main_test('      x=2\necho $x', '> > 2\n> ')
    main_test('echo x=2', '> x=2\n> ')
    main_test('x======5\necho $x', '> > =====5\n> ')
    main_test('x=="323"=@asd\'asdasd\'\n echo $x', '> > =323=@asdasdasd\n> ')
